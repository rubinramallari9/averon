...
AIEOServiceIcon.displayName = 'AIEOServiceIcon';
...
const servicesData = [
  ...
  },
  {
    iconType: 'aieo',
    title: "AIEO",
    description: "AI Engine Optimization — we structure your website so ChatGPT, Perplexity, Claude, and Gemini recommend your business when customers ask AI assistants for services like yours."
  }
] as const;
...
const ServiceIcon = memo(({ type }: { type: string }) => {
  switch (type) {
    ...
    case 'aieo': return <AIEOServiceIcon />;
    default: return null;
  }
});
...
const AveronWebsite = () => {
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden relative w-full" style={{
        ...
        <div className="max-w-7xl mx-auto backdrop-blur-xl bg-black/70 border border-purple-500/20 rounded-2xl px-4 sm:px-6 lg:px-8 shadow-xl">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex items-center gap-8">
              ...
              <Link href="/automations" className="text-sm font-medium text-white/80 hover:text-white transition-colors">
                Automations
              </Link>
              ...
              <a href="https://lumina.al" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-white/80 hover:text-white transition-colors flex items-center gap-1">
                Lumina
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden py-4 space-y-2 border-t border-purple-500/20 mt-2">
              ...
              <a
                ...
                className="block px-4 py-2 text-base font-medium text-white/80 hover:text-white hover:bg-white/5 rounded-lg transition-colors flex items-center gap-1"
                onClick={closeMobileMenu}
              >
                Lumina
                <svg className="w-3 h-3 opacity-60" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
        ...
        <div className="py-12 sm:py-16">
          <div className="w-full h-24 sm:h-32 lg:h-40">
            <div className="flex items-center justify-center gap-8 sm:gap-16 lg:gap-20 h-full px-4">
              <a href="https://lumina.al" target="_blank" rel="noopener noreferrer" className="h-full flex items-center relative w-56 sm:w-72 lg:w-96">
                <Image
              ...
              <div className="h-full flex items-center relative w-44 sm:w-56 lg:w-72">
                <Image
      ...
      {/* Automations Section */}
      <section id="automations" className="typography-b relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-emerald-400 text-sm font-semibold tracking-wider uppercase mb-4 block">AI-Powered</span>
            ...
            <p className="text-purple-200 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
              Let AI handle your customer interactions 24/7 — so you can focus on what matters most
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {/* Avox — Voice AI */}
            <div className="group relative bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:border-emerald-400/50 transition-all duration-300 p-6 sm:p-8 hover:shadow-2xl hover:shadow-emerald-500/20 hover:scale-[1.02]">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 via-teal-600 to-cyan-500 flex items-center justify-center mb-5 shadow-lg shadow-emerald-500/30">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                </svg>
              </div>
              <span className="text-emerald-400 text-xs font-semibold tracking-wider uppercase mb-2 block">Voice AI</span>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">Avox</h3>
              <p className="text-purple-200/80 text-sm sm:text-base leading-relaxed mb-5">
                An AI receptionist that answers calls, books appointments, and handles FAQs in Albanian and English — never misses a customer.
              </p>
              <ul className="space-y-2 mb-6">
                {["24/7 call answering", "Appointment booking", "Albanian & English support", "Routes urgent calls to you"].map((item) => (
            ...
            {/* Instagram DM Bot */}
            <div className="group relative bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:border-emerald-400/50 transition-all duration-300 p-6 sm:p-8 hover:shadow-2xl hover:shadow-emerald-500/20 hover:scale-[1.02]">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500 via-purple-600 to-orange-400 flex items-center justify-center mb-5 shadow-lg shadow-pink-500/30">
                <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                </svg>
              </div>
              <span className="text-pink-400 text-xs font-semibold tracking-wider uppercase mb-2 block">Instagram</span>
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">DM Bot</h3>
              <p className="text-purple-200/80 text-sm sm:text-base leading-relaxed mb-5">
                Auto-reply to DMs and comments instantly. Capture leads, send product catalogs, and convert followers into customers — 24/7.
              </p>
              <ul className="space-y-2 mb-6">
                {["Auto-reply to DMs & comments", "Lead capture sequences", "Product catalog delivery", "Works while you sleep"].map((item) => (
                  <li key={item} className="flex items-center gap-2 text-sm text-purple-200">
                    <svg className="w-4 h-4 text-emerald-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    </svg>
              ...
              <Link href="/automations#instagram-dm-bot" className="inline-flex items-center gap-2 text-emerald-400 text-sm font-semibold hover:text-emerald-300 transition-colors">
                Learn more <ArrowRightIcon />
              </Link>
            </div>
            ...
            {/* WhatsApp Bot */}
            <div className="group relative bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:border-emerald-400/50 transition-all duration-300 p-6 sm:p-8 hover:shadow-2xl hover:shadow-emerald-500/20 hover:scale-[1.02]">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-500 via-green-600 to-emerald-700 flex items-center justify-center mb-5 shadow-lg shadow-green-500/30">
                <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/automations#whatsapp-bot" className="inline-flex items-center gap-2 text-emerald-400 text-sm font-semibold hover:text-emerald-300 transition-colors">
                Learn more <ArrowRightIcon />
              </Link>
            </div>
          </div>
          ...
          <div className="text-center mt-10 sm:mt-14">
            <Link
              href="/automations"
              className="inline-flex items-center gap-2 px-8 py-4 bg-emerald-400 hover:bg-emerald-500 text-gray-900 rounded-full font-semibold transition-all transform hover:scale-105 shadow-lg shadow-emerald-500/50 text-base sm:text-lg"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-10">
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li><Link href="/automations" className="text-purple-200/70 hover:text-white text-sm transition-colors">Automations</Link></li>
